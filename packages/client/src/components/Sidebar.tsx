...
const styles = {
  ...
  channelActive: { background: "rgba(79,84,92,0.24)", color: "var(--text-primary)" } as CSSProperties,
  channelHover: { background: "rgba(79,84,92,0.16)", color: "var(--text-primary)" } as CSSProperties,
